...
CGV 공개 상영일정 조회 API를 **1분마다** 확인하고, 아래 조건의 IMAX 회차가 나타나면 Telegram으로 날짜와 시작시간을 즉시 알려줍니다.
...
알림을 보낸 회차는 로컬의 `data/notified.json` 또는 Railway 영구 볼륨에 저장되어 프로그램을 다시 시작해도 같은 날짜·시작시간을 중복 알림하지 않습니다.
...
• 2026-08-26 18:00 — IMAX관 / 종료 20:40
